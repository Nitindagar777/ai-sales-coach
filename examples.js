// Example sales conversations for the AI Sales Coach

const EXAMPLE_CONVERSATIONS = {
    // Cold Call Example (Needs Improvement)
    cold_call: `Salesperson: Hello, is this John? This is Mike from TechSolutions. How are you today?
...
Salesperson: Alright, I'll call back next week then. Have a good day!`,
    ...
    // Discovery Call Example (Good Example)
    discovery: `Salesperson: Good morning, Sarah. This is Alex from CloudServices. Is this still a good time for our scheduled call?
...
Salesperson: Noted. I'll make sure to focus on that. Thank you for your time today, Sarah. I'm looking forward to showing you how we can help address these challenges.`,
    ...
    objection: `Salesperson: Based on what we've discussed, our project management software seems to align well with your needs. What do you think?
